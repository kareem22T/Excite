...
const Footer = () => {
    useEffect(() => {
        const headings = document.querySelectorAll('ul h1');
        headings.forEach(heading => {
            heading.addEventListener('click', () => {
                heading?.parentElement?.parentElement?.classList.toggle('open');
            });
        });
    }, []);
    ...
    return (
        <footer>
            <div className="container">
                <div>
                    ...
                    <form action="">
                        ...
                        <path d="M9.91245 11.9998H4.00045L2.02345 4.1348C2.01079 4.0891 2.00308 4.04216 2.00045 3.9948C1.97845 3.2738 2.77245 2.7738 3.46045 3.1038L22.0004 11.9998L3.46045 20.8958C2.78045 21.2228 1.99645 20.7368 2.00045 20.0288C2.00247 19.9655 2.01359 19.9029 2.03345 19.8428L3.50045 14.9998" stroke="#FAFAFA" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </form>
                </div>
                <ul>
                    <li>
                        <h1>
                            ...
                            <path d="M11.5902 12.1373L16.2294 7.49805L17.5547 8.82329L11.5902 14.7878L5.62566 8.82328L6.9509 7.49805L11.5902 12.1373Z" fill="white"/>
                            </svg>
                        </h1>
                    </li>
            ...
            <div className="copy">
                ...
                <g clip-path="url(#clip0_27_23324)">
                <path d="M9.9974 18.3332C14.5998 18.3332 18.3307 14.6022 18.3307 9.99984C18.3307 5.39746 14.5998 1.6665 9.9974 1.6665C5.39502 1.6665 1.66406 5.39746 1.66406 9.99984C1.66406 14.6022 5.39502 18.3332 9.9974 18.3332Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.4974 8.14799C12.4974 8.14799 11.468 6.6665 9.7523 6.6665C8.03661 6.6665 6.66406 8.14799 6.66406 9.99984C6.66406 11.8517 8.03661 13.3332 9.7523 13.3332C11.468 13.3332 12.4974 11.8517 12.4974 11.8517" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
                <clipPath id="clip0_27_23324">
                <rect width="20" height="20" fill="white"/>
                </clipPath>
                </defs>
                </svg>
                Copyright EXCITE 2024. All right reserved
            </div>
        </footer>
    )
}
