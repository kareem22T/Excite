...
const FetchProduct: React.FC<FetchProductProps> = ({ brandId }) => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await axios.get<ApiResponse>(
                    `https://excite.techno-era.co/en/api/oscar/products/?ordering=-stockrecords__price%2Ctitle&brand=${brandId}&page=${currentPage}&page_size=12`
                );
